...
| underground-water-dynamics | 20 | 4 | 20% | ⚠️ |

### 12.4 已知问题

1. **underground-water-dynamics**: 15个案例因`gwflow`模块导入路径问题失败
2. **超时案例**: 4个复杂算法案例(智能控制、参数识别、强化学习等)超过30秒限制
